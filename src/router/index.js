...
const routes = [
  ...
  { path: '/pagina-principal', name: 'PaginaPrincipal', component: PaginaPrincipal },
  { path: '/iniciar-sesion', name: 'IniciarSesion', component: IniciarSesion },
  { path: '/registrar-cliente', name: 'RegistrarCliente', component: RegistrarCliente },
  { path: '/custom-moto', name: 'CustomMoto', component: CustomMoto },
  { path: '/deportivo-moto', name: 'DeportivoMoto', component: DeportivoMoto },
  { path: '/moto-calle', name: 'MotoCalle', component: MotoCalle },
